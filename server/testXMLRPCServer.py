...
try_call(server.master.getPropertyHistory, [["n0"]],{'n0':1})
try_call(server.master.getPropertyHistory, [["n0", "n0"], False, tendaysago, 'now'],{'n0':1})
try_call(server.master.getPropertyHistory, [["n0", "n1"], False, "now", tendaysfromnow],{})
try_call(server.master.getPropertyHistory, [["n0", "n1"], ["n0"], "now", tendaysfromnow],{})
